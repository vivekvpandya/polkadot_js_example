...
var index = require('../option/index.js');
 ...
 */
const unwrap = (either) => unrightOr(index$1.throws, either);
/**
 * Unwrap the right value. Throws if the either is a left.
 */
const unwrapLeft = (either) => unleftOr(index$1.throws, either);
/**
 ...
 * ```
 */
const unright = (either) => index.option(isRight(either) ? index.some(either.right) : index.none());
/**
 ...
 * ```
 */
const unleft = (either) => index.option(isLeft(either) ? index.some(either.left) : index.none());
/**
 ...
 * ```
 */
const unrightOr = (or, either) => isRight(either) ? either.right : _function.isFunction(or) ? or(either.left) : or;
/**
 ...
 * ```
 */
const unleftOr = (or, either) => isLeft(either) ? either.left : _function.isFunction(or) ? or(either.right) : or;
/**
