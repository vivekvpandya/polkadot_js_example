 ...
 */
export declare type TaskEither<L, R, Args extends ReadonlyArray<unknown>> = (...args: Args) => Ae.IAEither<L, R>;
/**
 ...
 */
export declare const from: <R, L = Error, Args extends readonly unknown[] = []>(fn: (...args: Args) => Promise<R>) => TaskEither<L, R, Args>;
