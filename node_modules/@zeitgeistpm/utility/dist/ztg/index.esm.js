 ...
 */
const isZtg = (value) => Decimal.isDecimal(value) && '__ztg' in value && value['__ztg'] === Ztg;
/**
 ...
 * @returns Ztg
 */
const mempty = () => wrap(new Decimal(0));
/**
 ...
 * @returns Ztg
 */
const fromNumber = (value) => wrap(new Decimal(value).mul(ZTG));
/**
...
export { ZTG, fetchZTGInfo, fetchZTGInfoFromCoingecko, fetchZTGInfoFromSubscan, fromNumber, isZtg, mempty, wrap };
