...
import type { ZeitgeistPrimitivesAsset, ZeitgeistPrimitivesMarketMarketCreation, ZeitgeistPrimitivesMarketMarketDisputeMechanism, ZeitgeistPrimitivesPoolScoringRule } from '@polkadot/types/lookup';
 ...
 */
export declare const isWithPool: <C extends RpcContext<MS>, MS extends MetadataStorage<{
    __meta: "markets";
    slug: string;
    description: string;
    question: string;
...
}, import("../../../../meta").CommentMetadata>>(params: CreateMarketParams<C, MS>) => params is CreateMarketWithPoolParams<C, MS>;
/**
 ...
 */
export declare type CreateMarketResult<C extends RpcContext<MS>, MS extends MetadataStorage> = {
