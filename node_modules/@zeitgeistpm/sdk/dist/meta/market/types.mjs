import { object, string, optional, union, literal, array } from 'superstruct';

/**
 * IO validation of Market Categories using superstruct
 */
const IOMarketCategoryMetadata = object({
    name: string(),
 ...
 */
union([literal('date'), literal('number')]);
/**
...
export { IOMarketCategoryMetadata, IOMarketMetadata };
