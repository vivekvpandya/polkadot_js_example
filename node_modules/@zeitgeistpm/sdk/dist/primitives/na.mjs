 ...
 * @returns value is NA
 */
const isNA = (value) => typeof value === 'object' &&
    isNotNull(value) &&
    '__type' in value &&
    value['__type'] === sym;
/**
 ...
 * @returns value is T
 */
const isAvailable = (value) => !isNA(value);

export { NA, isAvailable, isNA, na, reasonOf };
//# sourceMappingURL=na.mjs.map
