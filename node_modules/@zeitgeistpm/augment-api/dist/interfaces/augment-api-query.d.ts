    ...
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        assetRegistry: {
            ...
            locationToAssetId: AugmentedQuery<ApiType, (arg: XcmV1MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<ZeitgeistPrimitivesAsset>>, [XcmV1MultiLocation]>;
            /**
             * The metadata of an asset, indexed by asset id.
             **/
            metadata: AugmentedQuery<ApiType, (arg: ZeitgeistPrimitivesAsset | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<Option<OrmlTraitsAssetRegistryAssetMetadata>>, [ZeitgeistPrimitivesAsset]>;
        };
        authorFilter: {
            /**
        ...
        globalDisputes: {
             ...
             **/
            outcomes: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: ZeitgeistPrimitivesOutcomeReport | {
                Categorical: any;
            } | {
                Scalar: any;
            } | string | Uint8Array) => Observable<Option<ZrmlGlobalDisputesOutcomeInfo>>, [u128, ZeitgeistPrimitivesOutcomeReport]>;
            /**
        ...
        polkadotXcm: {
            ...
            versionNotifyTargets: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: XcmVersionedMultiLocation | {
                ...
                V1: any;
            } | string | Uint8Array) => Observable<Option<ITuple<[u64, u64, u32]>>>, [u32, XcmVersionedMultiLocation]>;
        };
        predictionMarkets: {
            /**
        ...
        tokens: {
             ...
             * balances.
             **/
            accounts: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: ZeitgeistPrimitivesAsset | {
                CategoricalOutcome: any;
            } | {
                ScalarOutcome: any;
            } | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<OrmlTokensAccountData>, [AccountId32, ZeitgeistPrimitivesAsset]>;
            /**
             * Any liquidity locks of a token type under an account.
             * NOTE: Should only be accessed when setting, changing and freeing a lock.
             **/
            locks: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: ZeitgeistPrimitivesAsset | {
                CategoricalOutcome: any;
            } | {
                ScalarOutcome: any;
            } | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<Vec<OrmlTokensBalanceLock>>, [AccountId32, ZeitgeistPrimitivesAsset]>;
            /**
             * Named reserves on some account balances.
             **/
            reserves: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: ZeitgeistPrimitivesAsset | {
                CategoricalOutcome: any;
            } | {
                ScalarOutcome: any;
            } | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<Vec<OrmlTokensReserveData>>, [AccountId32, ZeitgeistPrimitivesAsset]>;
            /**
             * The total issuance of a token type.
             **/
            totalIssuance: AugmentedQuery<ApiType, (arg: ZeitgeistPrimitivesAsset | {
                CategoricalOutcome: any;
            } | {
                ScalarOutcome: any;
            } | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<u128>, [ZeitgeistPrimitivesAsset]>;
        };
        transactionPayment: {
        ...
        unknownTokens: {
            ...
            abstractFungibleBalances: AugmentedQuery<ApiType, (arg1: XcmV1MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<u128>, [XcmV1MultiLocation, Bytes]>;
            /**
            ...
            concreteFungibleBalances: AugmentedQuery<ApiType, (arg1: XcmV1MultiLocation | {
                ...
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<u128>, [XcmV1MultiLocation, XcmV1MultiLocation]>;
        };
        utility: {};
        vesting: {
            /**
